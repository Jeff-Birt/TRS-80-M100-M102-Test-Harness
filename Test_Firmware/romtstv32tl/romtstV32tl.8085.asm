...
;						  RAM addresses.  
;			03 Jan 2020 - V3.2tl Skips power off test, does continious loop.
;
...
; Processor: 8080/8085
;
#DEFINE VERSION .text "V3.2" ; Change this value to update version
...
tstdonglins2ok:
		...
		ANI 003H				 ; Retrieve the Reset state should always be 1
		ADI 030H             ; Make into ASCII 0 or 1
		CALL putch
